                ...
                status === "problem" ? (
                    ...
                    <div className>
                        ...
                        <div className='text-[#B49372] p-4 font-semibold text-xl'>
                            ...
                            <div className='mt-1'>* will not communicate with other participants, use another person's code for solutions/generators, share ideas of solutions and hacks</div>
                            <div className='mt-1'>* will not attempt to deliberately destabilize the testing process and try to hack the contest system in any form</div>
                            <div className='mt-1'>* will not use multiple accounts and will take part in the contest using your personal and the single account.</div>
